...
#
# Generated by Vivado on Fri Nov 12 12:33:51 CET 2021
...
compile()
{
  ...
  vhdlan -work axi_timer_v2_0_19 $vhdlan_opts \
    "$ref_dir/../../../../project_1.srcs/sources_1/bd/design_1/ipshared/0a2c/hdl/axi_timer_v2_0_vh_rfs.vhd" \
  2>&1 | tee -a vhdlan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/mnt/DTU/3.sem/Hardware_Software_Programming/Project1/project_1/project_1.cache/compile_simlib/vcs"
  fi
